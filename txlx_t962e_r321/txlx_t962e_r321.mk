...
$(call inherit-product, device/amlogic/txlx_t962e_r321/device.mk)
...
PRODUCT_NAME := txlx_t962e_r321
PRODUCT_DEVICE := txlx_t962e_r321
PRODUCT_BRAND := Android
PRODUCT_MODEL := AOSP on txlx_t962e_r321
...
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.AB.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.AB.amlogic:root/fstab.amlogic
endif
else
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.amlogic:root/fstab.amlogic
endif
endif
else
ifeq ($(AB_OTA_UPDATER),true)
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.AB.verity.amlogic:recovery/root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.AB.amlogic:recovery/root/fstab.amlogic
endif
else
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.verity.amlogic:recovery/root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.amlogic:recovery/root/fstab.amlogic
endif
endif
endif
endif
...
PRODUCT_COPY_FILES += \
    device/amlogic/txlx_t962e_r321/fstab.3.14.amlogic:root/fstab.amlogic
endif
