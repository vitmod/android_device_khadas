...
#ROOTFS=$1
ROOTFS="out/target/product/txlx_t962x_r311/ramdisk.img"
...
if [ "$2" != "m" ]; then
    make -C common O=../$KERNEL_OUT txlx_t962x_r311.dtb ARCH=arm64 CROSS_COMPILE=$PREFIX_CROSS_COMPILE PARTITION_DTSI=partition_mbox.dtsi
fi
