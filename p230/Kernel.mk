...
BOARD_VENDOR_KERNEL_MODULES := $(PRODUCT_OUT)/obj/lib_vendor/audio_data.ko \
	...
	$(PRODUCT_OUT)/obj/lib_vendor/vavs.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vh264_multi.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vmjpeg.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vmpeg4.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vvc1.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/ddr_window_64.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/encoder.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vh264_4k2k.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vh264_mvc.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vmjpeg_multi.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vmpeg4_multi.ko \
	$(PRODUCT_OUT)/obj/lib_vendor/vvp9.ko \
	...
	$(PRODUCT_OUT)/obj/lib_vendor/vh264.ko \
